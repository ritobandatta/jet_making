...
int FastJetProcedure(int lower_lim,int upper_lim,int run){
  ...
  std::string output_file="/rs/rs_grp_majshen/tier1/ritoban/Binary_output_0.3/jets/JetscapeHadronListBin"+std::to_string(lower_lim)+"_"+std::to_string(upper_lim)+"_"+"Run"+std::to_string(run)+"_jets.out";
